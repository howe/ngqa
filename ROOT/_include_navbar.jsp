...
<div class="navbar-inner log-width pull-right">
    <a href="#" class="go163" title="与网易微博链接"></a>
    <a href="#" class="go360" title="用360帐号登录"></a>
    <a href="#" class="go10000" title="用天翼帐号登录"></a>
    <a href="#" class="go10010" title="用联通帐号登录"></a>
    <a href="${base}/user/login/douban" class="douban" title="用豆瓣帐号登录"></a>
    <a href="${base}/user/login/kaixin001" class="kaixin" title="用开心网帐号登录"></a>
    <a href="${base}/user/login/renren" class="renren" title="用人人网帐号登录"></a>
    <a href="${base}/user/login/sdo" class="sdo" title="用盛大通行证登录"></a>
    <a href="#" class="openid" title="用OpenID登录"></a>
    <a href="#" class="sohu" title="与搜狐微博链接"></a>
    <a href="#" class="tianya" title="用天涯帐号登录"></a>
    ...
    <a href="${base}/user/login/msn" class="msn" title="用Windows Live帐号登录"></a>
